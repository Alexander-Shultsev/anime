...
import com.example.stimulation2.databinding.FragmentUserHeaderWithoutNumberBinding
import com.example.stimulation2.sign.SignIn
import okhttp3.*
import java.io.IOException

class UserHeaderWithoutNumber : Fragment() {


    private lateinit var binding: FragmentUserHeaderWithoutNumberBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentUserHeaderWithoutNumberBinding.inflate(inflater, container, false)
...
//        requireActivity().finish()
    ...
    private fun getUserData() {
        formBody = FormBody.Builder()
            .add("id_user", Global.token.toString())
            .build()
    ...
    private fun putUserData(data: Array<AuthorizationUser>) {
        ...
        binding.typeUser.text = Global.type_user
    }
